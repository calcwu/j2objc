...
SKIP_INFRA_LIB_MODULES=("blobstore-s3" "configutils" "crypto" "distributedlocks" "filemuncher" "grpc" "guice" "jersey" "jetty-filter" "jetty" "jooq" "jsonapi" "kafka-server" "kafka" "kryo" "lang" "logging" "maxwell" "mongo" "multistage" "parquet" "request" "rest" "secrets" "ssl" "syndicatedcache" "testing" "threads" "kafka-admin")
